...
link:crates/git-store/README.adoc#script-boundary[`crates/git-store/README.adoc`].
...
* link:crates/facet-git-tree[`facet-git-tree`] — Git tree encoding for Facet types.
* link:crates/gix-refstore[`gix-refstore`] — compare-and-swap storage for Git refs.
* link:crates/gix-store[`gix-store`] — schema-aware storage for Rust programs.
* link:crates/git-store[`git-store`] — the command-line interface.

== Documentation

* link:docs/specification.adoc[`docs/specification.adoc`] — tree serialization and deserialization.
* link:CONTRIBUTING.adoc[`CONTRIBUTING.adoc`] — contribution guide.
* link:CONDUCT.adoc[`CONDUCT.adoc`] — code of conduct.
